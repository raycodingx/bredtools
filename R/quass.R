## Given the vectors of sire and dam, directly return inverse of additive relationship matrix 'A' without creating the 'A' itself. This is a modification of Henderson's method and unlike createAinv.r, this can be used in inbred populations.
...
## Literature: Quass, R. L. 1976. Computing the Diagonal Elements and Inverse of a Large Numerator Relationship Matrix. Biometrics 32:949-953.
...
#'
#' @param s a vector of sire
#' @param d a vector of dam
#'
